...
function SearchableDropdown({ label, options, value, onChange, placeholder = "Search..." }) {
    ...
    <div className="relative inline-block text-left" ref={dropdownRef}>
      <div>
        <button
          ...
          className="bg-zinc-55 border border-zinc-200 rounded-lg py-1.5 px-3 text-[11px] font-bold text-zinc-700 focus:outline-none hover:bg-zinc-100 transition-smooth flex items-center justify-between gap-1.5 min-w-[120px] cursor-pointer"
        >
      ...
      {isOpen && (
        <div className="origin-top-right absolute right-0 mt-1 w-48 rounded-lg shadow-lg bg-white border border-zinc-100 ring-1 ring-black/5 z-55 animate-fade-in">
