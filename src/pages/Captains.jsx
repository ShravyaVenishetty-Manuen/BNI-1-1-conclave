...
const initialCaptains = [
  {
    ...
    drawerImage: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBD9RgLsLKNJjme7fStZB1zXB8i8PXuVdfv0xeg0LF935ZPsGZZ-A2NB2mFyjPTG1HZh9HCieFf1PWsHgmons8ZvRh5LJR1XnxVyfVJS0ZF_prH_y2xnAKWTIYmyYeFfia5-PVh8TVCdgKNhJcTeYNBfBNaFfUjP7Q_gPEf87kfJaLOiM1On4a4KcoPY2D8tsiJDitMu3mWVudXO9zCADxFsdZx5aDpxWaxWvuDWwA1uY78McgmqUZZCnos1LjMp4PtM9Yz6RT63dA',
    history: [
      { conclave: 'Global Annual 2022', table: '05', rating: 5 },
      { conclave: 'Regional Spring 2023', table: '18', rating: 4 }
    ],
    timeline: [
      { event: 'Completed South Chapter Conclave', date: 'Sept 28, 2023', note: 'Led Table 12' },
      { event: 'Profile Verified by Admin', date: 'Aug 15, 2023', note: 'Compliance check passed' },
      { event: 'Onboarded as Captain', date: 'Aug 01, 2023', note: 'Certification completed' }
    ]
  },
  {
    id: 'BNI-4412-M',
    ...
    drawerImage: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDDizJhD8bIRWT1DT0VnCLSYB_A_JuTKtI7_QYXDLxLkIvA0rP18fQlTKse9S8EoV_UN2dNR_gODJAf0FaDgTZstRGhKj2v90gZHjrHQ06oPreQnn3wF4BqfJvzKMBQpoKJcX4G3hJQ4JVA3vwT6z2k5qIrSc2utPuml2S8GVYxtOYL_PwrRqFvWtbmpfSBxXj7MrOMM9sFydWal9sHgu4o4Z8qTW6mPNAw7RBqNf069xKW8xrn69VelkbjTZEW0dSbS63nI_gRR3Y',
    history: [
      { conclave: 'Regional Winter Conclave', table: '04', rating: 5 }
    ],
    timeline: [
      { event: 'Assigned to South Chapter Conclave', date: 'Oct 02, 2023', note: 'Active Role' },
      { event: 'Real Estate Compliance Cleared', date: 'Jul 10, 2023', note: 'No Conflict Found' }
    ]
  },
  {
    id: 'BNI-9018-K',
    ...
    email: 'd.chawla@chawlapartners.law',
    table: 'Unassigned',
    ...
    drawerImage: 'https://lh3.googleusercontent.com/aida-public/AB6AXuC1r9ZwwkMbvsS197M3RxXmwFXJiIx5CSY9B3gZ3ed9tUbG_WdU9k0dy-CEyeGMtsOd3ScBPZTviacTOYFOZutH1K80ip_My5tri2DPjCC_wJoSVv_fzFae7UTpHUbAGmMeg7JIx_xMHWmxxsfKXEfJEpngVrdgeTM9Xr0IzzDPNFPG6de2EQHM_qLjvBmNc96RxiJUALcYAqCoFtIU027prTkX2O2zQLb_oj9z_G0JxDeOu5j0yvLmzv6t1F7hDemJcK9puv0er5Q',
    history: [
      { conclave: 'Apex Growth Summit', table: '12', rating: 4 }
    ],
    timeline: [
      { event: 'Legal Panel Onboarding', date: 'Dec 12, 2022', note: 'Certified Representative' }
    ]
  },
  {
    id: 'BNI-1205-L',
    ...
    history: [],
    timeline: [
      { event: 'Joined BNI Regional Network', date: 'Jul 18, 2022', note: 'Assigned as Tech Lead' }
    ]
  },
  {
    id: 'BNI-0482-R',
    ...
    table: 'Table 12 (South Chapter)',
    joinDate: 'Jan 10, 2023',
    chapter: 'Peak Performance',
    image: null,
    drawerImage: null,
    history: [
      { conclave: 'Regional Growth Seminar', date: 'Aug 05, 2023', rating: 5 }
    ],
    timeline: [
      { event: 'Assigned to South Chapter Table 12', date: 'Sep 28, 2023', note: 'Active Captain' }
    ]
  }
];
