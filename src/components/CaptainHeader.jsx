      ...
      <header className="w-full bg-white border-b border-zinc-200 sticky top-0 z-40 px-4 sm:px-6 h-16 flex items-center justify-between shadow-xs font-sans">
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          ...
          <div className="hidden sm:flex flex-col border-l border-zinc-200 pl-2.5">
            <span className="text-[12px] font-black text-zinc-955 tracking-tight leading-none">Captain Portal</span>
        ...
        <div className="flex items-center gap-3 sm:gap-4 shrink-0">
          ...
          <div className="group relative flex items-center gap-2.5 cursor-pointer shrink-0">
            ...
            <div className="hidden md:flex flex-col">
              <span className="text-[12.5px] font-extrabold text-zinc-955 leading-none whitespace-nowrap">{loggedInCaptain.name}</span>
              <span className="text-[8.5px] text-zinc-450 font-bold uppercase tracking-wider mt-0.5">Captain</span>
            </div>
